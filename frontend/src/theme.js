...
export const LINEN = '#D1D3CF';
export const RAISIN = '#757081';
...
export const INDIGO = '#30415D';
export const ULTRAMARINE = '#031424';
export const LIGHT_BLUE = '#8EAEBD';
...
export const H1_SIZE = fontSizeBase * 1.8;
...
export default {
    ...
    // FooterTab
    tabBarTextColor: (platform === 'ios') ? LINEN : LINEN,
    tabBarTextSize: (platform === 'ios') ? 14 : 11,
    activeTab: (platform === 'ios') ? '#007aff' : '#fff',
    sTabBarActiveTextColor: '#007aff',
    tabBarActiveTextColor: (platform === 'ios') ? '#ffffff' : '#ffffff',
    tabActiveBgColor: (platform === 'ios') ? GRAPE : GRAPE,
    ...
    toolbarDefaultBg: (platform === 'ios') ? LAVENDER : LAVENDER,
